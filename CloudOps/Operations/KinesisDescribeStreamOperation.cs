...
{
    public class KinesisDescribeStreamOperation : Operation
    {
        ...
        public override void Invoke(AWSCredentials creds, RegionEndpoint region, int maxItems)
        {
            ...
            DescribeStreamOutput resp = new DescribeStreamOutput();
            do
            {
                DescribeStreamInput req = new DescribeStreamInput
                {
            ...
            while (!string.IsNullOrEmpty(resp.StreamDescription.Shards[-1].ShardId));
        }
    }
}