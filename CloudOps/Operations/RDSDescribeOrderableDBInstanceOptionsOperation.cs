...
namespace CloudOps.Operations
{
    public class RDSDescribeOrderableDBInstanceOptionsOperation : Operation
    {
        ...
        public override void Invoke(AWSCredentials creds, RegionEndpoint region, int maxItems)
        {
            ...
            OrderableDBInstanceOptionsMessage resp = new OrderableDBInstanceOptionsMessage();
            do
            {
                DescribeOrderableDBInstanceOptionsMessage req = new DescribeOrderableDBInstanceOptionsMessage
                {
                    Marker = resp.Marker,
                    MaxRecords = maxItems
                };
