...
namespace CloudOps.Operations
{
    public class Route53ListResourceRecordSetsOperation : Operation
    {
        ...
        public override string RequestURI => "/2013-04-01/hostedzone/{Id}/rrset";
        ...
        public override void Invoke(AWSCredentials creds, RegionEndpoint region, int maxItems)
        {
            ...
            ListResourceRecordSetsResponse resp = new ListResourceRecordSetsResponse();
            do
            {
                ListResourceRecordSetsRequest req = new ListResourceRecordSetsRequest
                {
                    [StartRecordName StartRecordType StartRecordIdentifier] = resp.[NextRecordName NextRecordType NextRecordIdentifier],
                    MaxItems = maxItems
                };
            ...
            while (!string.IsNullOrEmpty(resp.[NextRecordName NextRecordType NextRecordIdentifier]));
        }
    }
}