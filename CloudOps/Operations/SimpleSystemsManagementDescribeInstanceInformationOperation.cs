...
{
    public class SimpleSystemsManagementDescribeInstanceInformationOperation : Operation
    {
        ...
        public override void Invoke(AWSCredentials creds, RegionEndpoint region, int maxItems)
        {
            ...
            DescribeInstanceInformationResultResponse resp = new DescribeInstanceInformationResultResponse();
            do
            {
