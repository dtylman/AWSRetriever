...
{
    public class SimpleSystemsManagementListCommandInvocationsOperation : Operation
    {
        ...
        public override void Invoke(AWSCredentials creds, RegionEndpoint region, int maxItems)
        {
            ...
            ListCommandInvocationsResultResponse resp = new ListCommandInvocationsResultResponse();
            do
            {
