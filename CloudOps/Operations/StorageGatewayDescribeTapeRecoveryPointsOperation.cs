...
{
    public class StorageGatewayDescribeTapeRecoveryPointsOperation : Operation
    {
        ...
        public override void Invoke(AWSCredentials creds, RegionEndpoint region, int maxItems)
        {
            ...
            DescribeTapeRecoveryPointsOutput resp = new DescribeTapeRecoveryPointsOutput();
            do
            {
                DescribeTapeRecoveryPointsInput req = new DescribeTapeRecoveryPointsInput
                {
                    Marker = resp.Marker,
                    Limit = maxItems
                };
